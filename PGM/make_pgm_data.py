...
#path = ['./data/neutral_0/', './data/neutral_1/', './data/neutral_2/', './data/neutral_3/',  './data/neutral_4/',  './data/neutral_5/',  './data/neutral_6/',  './data/neutral_7/',  './data/neutral_8/',  './data/neutral_9/']
...
class Raven_Data(Data.Dataset):
    ...
    def __getitem__(self, index):
            ...
            return target['image'].reshape(16,160,160), a, b, idx
...
def raven_loader(batch_size,  train = True, val = False, num_workers = 16):
    ...
    return DataLoader(dataset, batch_size = batch_size, sampler = None, collate_fn = yolo_dataset_collate, shuffle = True, num_workers = num_workers, pin_memory = True, prefetch_factor=4), len(dataset)
